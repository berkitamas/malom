...
/*! \mainpage Malom játék
 *
 * \section intro Bevezető
 *
 ...
 *
 * \image 		html board.png "Malom tábla" width=100%
 *
 * \section about A játékról
 *
 ...
 *
 * \section install Telepítés
 *
 * \subsection step1 1. lépés: Lefordítjuk
 *
 * ```
 * make
 * ```
 * \subsection step2 2. lépés: Futtatjuk
 *
 * ```
 * bin/malom
 * ```
 *
 * \section references Kapcsolódó linkek
 *
...
/**
 * @brief      A belépési pont
 *
 * @return     A kilépésnél lévő visszatérési érték
 */
int main()
{
	game_init();
